...
const Footer = () => {
  return (
    <footer className="flex flex-row bg-[#1A1A1A] rounded-full p-4 justify-between text-[#B3B3B3] items-center mx-5 max-[978px]:flex-col max-[978px]:gap-4 max-[978px]:rounded-xl">
      ...
      <p>Deckard Digital Bank  todos los derechos reservados.</p>
