...
const Aside = () => {
  return (
    <section className="flex flex-col gap-10 bg-[#1C1C1C] p-10">
      ...
      <aside className="flex flex-row justify-center max-[760px]:hidden">
        <ul className="flex justify-start gap-10 menu text-white">
          <li>
            <a href="" className="efecto-azul">
              Inicio
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="" className="efecto-morado">
              Regístrate
            </a>
          </li>
          <li>
